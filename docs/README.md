...
heroImage: /hero.png
heroText: Hurley's 校招面经 # 首页的标题内容
actionText: 进入文档首页 → # 首页跳转按钮的内容
actionLink: /index/
features: # 表明首页的特征，固定的格式为title + details，以三栏流式布局的方式展示
  - title: 📚 校招面经
    details: 本面经是面向Android/Java技术方向的校招求职者，包括Java语言、操作系统、网络等知识及面试经验等
  - title: 🔋 VuePress驱动
    details: 以Markdown为中心的项目结构，打造校招面经的知识笔记
  - title: 👨🏻‍💻 关于我
